...
public class Player extends Entity{
    ...
    public static void gewinnen(Player spieler){
        ...
        if(Touch(spieler.figur,GameWorld.Ausgang)){
            ...
            GameWorld.ausgabe.setText("Spieler " + spieler.figur.getText() + " muss noch "+(50-spieler.heilmittel_anzahl)+" Heilmittel einsammeln");
        ...
        for (int i = 0; i < GameWorld.heilmittel.length; i++) {
            ...
            if(Touch(spieler.figur,GameWorld.heilmittel[i])){
                if(spieler.heilmittel_anzahl < GameWorld.heilen/2){
                    ...
                    GameWorld.ausgabe.setText("Spieler "+spieler.figur.getText()+" hat "+spieler.heilmittel_anzahl+ " Heilmittel eingesammelt");
